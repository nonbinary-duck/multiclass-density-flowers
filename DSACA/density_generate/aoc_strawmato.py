...
root = '../dataset/aoc_strawmato_ripe'

test_label_pth = os.path.join(root, 'val/labels')
...
strawds_category_buf = ["r_strawberry", "u_strawberry", "r_tomato", "u_tomato"]



kernel_size_buf = [14, 12, 12, 10]
